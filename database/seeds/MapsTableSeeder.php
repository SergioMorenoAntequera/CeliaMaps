...
class MapsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('maps')->insert([    
            ...
            'miniature' => '2map.png',
            'level' => '2',
            'tlCornerLatitude' => '36.8473326790705200',
            'tlCornerLongitude' => '-2.4914395809173590',
            'trCornerLatitude' => '36.8473326790705200',
            'trCornerLongitude' => '-2.4498009681701665',
            'blCornerLatitude' => '36.8303742321529340',
            'blCornerLongitude' => '-2.4914395809173590',
            'brCornerLatitude' => '36.8303742321529340',
            'brCornerLongitude' => '-2.4498009681701665',
            'created_at' => date('Y-m-d H-m-s'),
            'updated_at' => date('Y-m-d H-m-s'),
        ]);
