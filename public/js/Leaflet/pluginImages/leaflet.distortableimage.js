...
L.Utils = {
  initTranslation: function() {
    var translation = {
      ...
      deleteImages: 'Borrar imagen',
      distortImage: 'Distorsionar imagen',
      dragImage: 'Arrastras imagen',
      exportImage: 'Export Image',
      exportImages: 'Export Images',
      removeBorder: 'Quitar Bordes',
      addBorder: 'Añadir Borde',
      freeRotateImage: 'Escalar y Rotar imagen',
      geolocateImage: 'Geolocate Image',
      lockMode: 'Modo de bloqueo',
      lockImages: 'Bloquear imagen',
      makeImageOpaque: 'Hacer la imagen Opaca',
      makeImageTransparent: 'Hacer la imagen transparente',
      restoreOriginalImageDimensions: 'Devolver dimensiones originales',
      rotateImage: 'Rotar Imagen',
      scaleImage: 'Escalar Imagen',
