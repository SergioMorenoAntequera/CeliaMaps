    ...
    <div class="wholePanel">
        ...
        <div class="rightPanel">
            ...
            @endisset
                ...
                <!-- MODAL USUARIO REGISTRADO CON ÉXITO -->
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="staticBackdropLabel">Usuario registrado con éxito</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                            </div>
                            <div class="modal-body">
                                ¿Desea seguir registrando usuarios?
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-success" data-dismiss="modal">Continuar</button>
                                <a href="{{route('user.index')}}">
                                <button type="button" class="btn btn-outline-success" autofocus>Salir</button>
                                </a>
                            </div>
                        </div>
                    </div>
                </div>
                <!-- FIN DE MODAL USUARIO REGISTRADO CON ÉXITO -->
        </div>
    </div>
</div>
