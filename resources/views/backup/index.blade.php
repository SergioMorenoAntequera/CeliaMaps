...
<div class="container">
    ...
    <div class="row mt-5">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="confirmCreate" type="button" class="btn btn-success" data-dismiss="modal">Crear
                            copias</button>
                    </div>
                </div>
            </div>
        ...
        <div id="mensajeGenerarModal" class="modal" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button id="cerrarCrear" type="button" class="btn btn-success"
        ...
        <!-- Modal restaurar -->
        <div class="modal fade" id="restoreModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <p>
                            Si continua, se restaurará una copia de seguridad de las imágenes contenidas en la
                            aplicación,
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" data-dismiss="modal"> Cancelar </button>
                        <button id="confirmRestore" type="button" class="btn btn-success" data-dismiss="modal">Restaurar
                            copias</button>
                    </div>
                </div>
            </div>
        ...
        <div id="mensajeRestaurarModal" class="modal" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button id="cerrarRestaurar" type="button" class="btn btn-success"
                            data-dismiss="modal">Aceptar</button>
                    </div>
                </div>
            </div>
